...
////Quantité (en attente) ////////////////////////////////////////////////////////////////
// const quantity = document.querySelectorAll("#exampleFormControlSelect1");

// for(let p=0;p<quantity.length;p++){

// quantity[p].addEventListener("change",(event)=>{
// event.preventDefault();
// console.log(event)
// console.log(checkLocalStorage)

// const quantityValue = document.getElementById("exampleFormControlSelect1").value

// console.log(quantityValue)

// checkLocalStorage[p].productQuantity = quantityValue
...
///// Bouton Vidage Panier ////

// const btn_cartEmpty = `
// <button class="btn p-2 bg-light border m-3" id ="cartEmpty"> Vider le Panier</button>`


// containerProductCart.insertAdjacentHTML("beforeend",btn_cartEmpty)
